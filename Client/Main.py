...
class MyWindow(QMainWindow,Ui_client):
    def __init__(self):
        ...
        self.detection_video_label.setFixedSize(480, 360)     #___________ detection pencere boyutu
        self.detection_video_label.move(850, 350)             #__________ detection pencere pozisyonu
