...
class MyWindow(QMainWindow,Ui_client):
    ...
    def display_video(self,ip):
        ...
        try:
            self.client.client_socket.bind((ip, 8002))
            self.client.client_socket.listen(1)
            conn, addr = self.client.client_socket.accept()
        except Exception as e:
            print(f"Error display_video connection: {str(e)}")
