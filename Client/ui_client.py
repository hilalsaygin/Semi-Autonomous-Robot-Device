...
"background:  transparent;} ")
        ...
        self.lineEdit_IP_Adress.setGeometry(QtCore.QRect(100, 150, 220, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.Button_Connect.setGeometry(QtCore.QRect(360, 145, 130, 40))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.Button_Otonom.setGeometry(QtCore.QRect(100, 250, 180, 40))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setBold(False)
        font.setWeight(50)
        ...
        self.Button_Manuel.setGeometry(QtCore.QRect(320, 250, 120, 40))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setBold(False)
        font.setWeight(50)
        ...
        self.progress_Power.setGeometry(QtCore.QRect(150, 50, 220, 40))
        font = QtGui.QFont()
        font.setFamily("Arial")
