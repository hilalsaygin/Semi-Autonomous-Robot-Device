...
"background:  transparent;} ")
        ...
        self.Button_Otonom.setGeometry(QtCore.QRect(45, 410, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setBold(False)
        font.setWeight(50)
        self.Button_Otonom.setFont(font)
        self.Button_Otonom.setStyleSheet("font: 10pt \"Arial\";")
        ...
        self.Button_Manuel.setGeometry(QtCore.QRect(450, 410, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setBold(False)
        font.setWeight(50)
        self.Button_Manuel.setFont(font)
        self.Button_Manuel.setStyleSheet("font: 10pt \"Arial\";")
        self.Button_Manuel.setObjectName("Button_Manuel")
        self.Button_Ball_And_Face = QtWidgets.QPushButton(client)
        self.Button_Ball_And_Face.setGeometry(QtCore.QRect(670, 970, 90, 30))
    ...
    def retranslateUi(self, client):
        ...
        self.Button_Otonom.setText(_translate("client", "Otonom"))
