...
"background:  transparent;} ")
        ...
        self.Button_Video.setGeometry(QtCore.QRect(100, 400, 100, 40))
        font = QtGui.QFont()
        font.setFamily("Lato")
        self.Button_Video.setFont(font)
        self.Button_Video.setStyleSheet("font: 11pt; border: 2px solid white; background-color: #696969; border-radius: 5px")
    ...
    def retranslateUi(self, client):
        ...
        self.Button_Video.setText(_translate("client", "Video"))
