...
model_info = classifier.fit_generator(training_set, steps_per_epoch=steps_per_epoch, epochs=50, validation_data=test_set,
                                      validation_steps=validation_steps, callbacks=[csv_logger, early_stopping_monitor])

classifier.save("drawing_classification.h5")	# %72 accuracy with 35 epochs
#classifier.save("my_classification.h5")	# %x accuracy
'''
